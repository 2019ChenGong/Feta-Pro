...
accountant.history = [(30, 1., 1), (5, 1., 5)]
accountant.history.append((2, 4096/60000, 60000//4096*150))

eps, alpha = accountant.get_privacy_spent(delta=1e-5)
print(eps, alpha)
eps, alpha = accountant.get_privacy_spent(delta=1e-5, alphas=alpha)
print(eps, alpha)