...
if __name__ == '__main__':
    ...
    parser.add_argument('-i', '--input', type=str, default='exp/pe/mnist_28_vd70-2025-05-07-02-12-03/gen/gen.npz', help='Path to the .npz file')
    parser.add_argument('-o', '--output', type=str, default='exp/pe/mnist_28_vd70-2025-05-07-02-12-03/gen/', help='Output directory for PNG images')
